...
CSV.foreach('k-shell-controlabilidad.csv', headers: true).each do |row|
...
create_graphic "shell-controllability-by-shell.jpg", by_shell_heatmap, 8, 10
create_graphic "shell-controllability-by-controllability.jpg", by_controlability_heatmap, 10, 8
